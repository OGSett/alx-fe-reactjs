...
const Home = () => {
    ...
    return ( 
        ...
        <section key={index} className="lg:mix-w-[456px] md:w-[100%] h-[100%] md:h-[80%] lg:h-[60%] bg-gray-300 m-auto rounded-md md:hover:scale-105  hover:shadow-lg hover:shadow-gray-400 transition duration-200 p-2 flex flex-col justify-around items-center cursor-pointer">
