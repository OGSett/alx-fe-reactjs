...
const Home = () => {
    ...
    return ( 
        ...
        <section key={index} onClick={() => setGoTo(dataR.id)} className="lg:mix-w-[456px] md:w-[100%] h-[100%] md:h-[80%] lg:h-[60%] bg-recipe-mid m-auto rounded-md md:hover:scale-105  hover:shadow-lg hover:shadow-gray-400 transition duration-200 p-2 flex flex-col justify-around items-center cursor-pointer">
            ...
            <p className="font-poppins text-recipe-dark p-2 lg:text-[20px] text-[14px] text-center lg:min-h-[170px]">{dataR.summary}</p>
        </section>
        ))}
        </div>
     ); 
