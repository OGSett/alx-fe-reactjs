...
const Home = () => {
    ...
    return ( 
        ...
        {dataArray.map((dataR, index) => (
            <Link key={dataR.id} to={`/recipe/${dataR.id}`} className="lg:mix-w-[456px] md:w-[100%] h-[100%] md:h-[80%] lg:h-[60%] bg-recipe-mid m-auto rounded-md md:hover:scale-105  hover:shadow-lg hover:shadow-gray-400 transition duration-200 p-2 flex flex-col justify-around items-center cursor-pointer" >
        {/* <section  > */}
