    ...
    return ( 
        <div className="w-[95%] sm:w-[70%] md:w-[50%] h-full mx-auto flex flex-col items-center justify-center gap-8 font-poppins">
            ...
            <div className="flex flex-col md:flex-row gap-2 md:w-full">
                <div className="bg-recipe-mid p-2 shadow-md shadow-gray-400 transition duration-200 rounded my-2  md:w-[50%]">
                    <span className=" mb-[5px] font-playfair tracking-[1px] lg:text-3xl text-[19px] font-semibold text-center md:min-h-[72px] my-2 md:my-0 lg:text-[30px] md:text-[20px] ">ingredients</span>
                    <p className="my-2">{recipe.ingredients}</p>
                </div>
                <div className="bg-recipe-mid p-2 shadow-md shadow-gray-400 transition duration-200 rounded my-2 md:w-[50%]">
